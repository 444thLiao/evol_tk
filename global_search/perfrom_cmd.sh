...
python3 /home-user/thliao/script/evolution_relative/global_search/get_info.py -i ./nr_retrieve_amoA/cluster_90_aln.dir/iqtree.treefile/used_ids.list -o nr_retrieve_amoA/cluster_90_aln.dir/iqtree.treefile/

# amoA
python3 ~/script/evolution_relative/global_search/build_tree_exe.py ./nr_retrieve_removeENV_amoA/cluster_98 .newick
python3 /home-user/thliao/script/evolution_relative/global_search/get_info.py -i ./nr_retrieve_removeENV_amoA/cluster_98_aln.dir/iqtree.treefile/used_ids.list -o nr_retrieve
_removeENV_amoA/cluster_98_aln.dir/iqtree.treefile/
