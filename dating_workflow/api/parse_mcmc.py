...
def main(indir,ns,groupname,odir):
    ...
    interate_dir = list(glob(join(indir,'*')))
    name = ''
    ...
    odir = join(odir,'infinite_site_plot')#'./dating_for/83g/clock2_infinite_plot'
...
indir = './dating_for/test_add_cal_inside/diff_cal/clock2/'
