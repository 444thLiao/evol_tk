...
def main(indir, name2group, odir, 
    ...
    for each_dir in tqdm(processed_dir):
        ...
        tmp_df.loc[set_name, 'ROOT'] = '%s (%s) ' % (post_df.loc[root_name,'Posterior mean time (100 Ma)'],
        ...
        for gname, group in name2group.items():
            ...
            tmp_df.loc[set_name, gname] = '%s (%s) ' % (post_df.loc[raw_name,'Posterior mean time (100 Ma)'],
